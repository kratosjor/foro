    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publicaciones', to='foro_aplicacion.categoria')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comentarios', to='foro_aplicacion.publicacion')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('etiqueta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foro_aplicacion.etiqueta')),
                ('publicacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foro_aplicacion.publicacion')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='etiquetas',
            field=models.ManyToManyField(related_name='publicaciones', through='foro_aplicacion.PublicacionEtiqueta', to='foro_aplicacion.etiqueta'),
        ),
        migrations.CreateModel(
            name='Voto',
            fields=[
                ...
                ('publicacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votos', to='foro_aplicacion.publicacion')),
