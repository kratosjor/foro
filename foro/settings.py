...
SECRET_KEY = 'django-insecure-5w1$fp&g$!y)s_1xqw9py93+-e%6282*5696tdn7d-$k)n*%a5'
...
INSTALLED_APPS = [
    ...
    'foro_aplicacion',  # Aplicación del foro
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',
                'foro_aplicacion.context_processors.cantidad_notificaciones',
            ],
        },
    },
]
...
AUTH_USER_MODEL = 'foro_aplicacion.Usuario'
